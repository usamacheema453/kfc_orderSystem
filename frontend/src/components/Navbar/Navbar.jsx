...
const Navbar = () => {
  return (
    <>
      {/* Main container */}
      <div className="fixed top-0 left-0 w-full bg-black z-50 py-4 px-4 sm:px-16 ">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:flex md:flex-row sm:gap-x-3 gap-y-2 sm:gap-y-0 mb-4 sm:mb-0">
        ...
        <div className="md:hidden sm:mt-0 w-full sm:flex flex-row sm:justify-center">
          <div className="flex justify-center gap-4 sm:gap-x-3 gap-y-2 mt-3 sm:gap-y-0">
            {/* Delivery Option */}
            <div className="flex items-center bg-[#1C1816] px-4 py-2 rounded-md">
              <img src="/images/deliver.png" className="w-6 h-6" alt="delivery" />
      ...
      {/* Adding margin to avoid content being hidden behind fixed navbar */}
